...
CI_DECLARE_MOD_DATA ci_service_module_t service = 
{
     ...
     "Record service V2.4",            /* mod_short_descr,  Module short description */
...
static void print_record_conf(const struct RecordConf* conf)
{
	...
	ci_debug_printf(5,"db_socket: %s\n",conf->db_socket);
	ci_debug_printf(5,"db_port: %u\n",conf->db_port);
	ci_debug_printf(5,"url_record_size: %u\n",conf->url_record_size);
	ci_debug_printf(5,"full_url: %d\n",conf->full_url);
	ci_debug_printf(5,"record_url: %d\n",conf->record_url);
	ci_debug_printf(5,"record_word: %d\n",conf->record_word);
}
